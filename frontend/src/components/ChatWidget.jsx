  ...
  return (
    <div className="fixed bottom-5 right-5 z-30">
      {open ? (
        ...
        <button onClick={() => setOpen(true)} title="Abrir chat" className="flex items-center justify-center rounded-full bg-primary-600 p-4 text-white shadow-panel transition hover:scale-105 hover:bg-primary-700">
